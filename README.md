...
1. **Instantiate**: `pm = get_portfolio_manager()`; it loads/saves state in `config/backups/portfolio_state.json` and keeps daily history in `reports/portfolio_history/`.
