            ...
            try:
                ...
                try:
                    if DEPENDENCIES_AVAILABLE:
                        ...
                        msg1_parts.append(
                            f"{EMOJI['bullet']} {noon_connection.get('predictions_summary', 'Prediction accuracy: see Evening Performance Review / Daily Summary')}"
                        )
                        msg1_parts.append(
                            f"{EMOJI['bullet']} {noon_connection.get('regime_status', 'Market regime: see ML Sentiment blocks (Noon/Evening)')}"
                        )
                    else:
