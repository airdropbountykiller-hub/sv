...
CONTENT_SCHEDULE_CONFIG = {
    "press_review": "07:00",      # Press Review (7 sections)
    "morning": "08:30",          # Morning Report (3 messages)
    "noon": "13:00",             # Noon Update (3 messages) - ALWAYS "NOON"
    "evening": "18:30",          # Evening Analysis (3 messages)
    "summary": "20:00",          # Daily Summary (6 pages)
    "weekly": "08:35",           # Weekly Report (Monday only)
