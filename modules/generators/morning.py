...
def generate_morning_report(ctx) -> List[str]:
    """MORNING REPORT 09:00 - ENHANCED version with 3 messages
    ...
    try:
        ...
        try:
            ...
            # Enhanced continuity connection with press review 06:00
            msg1_parts.append(f"{EMOJI['world']} *PRESS REVIEW FOLLOW-UP (from 06:00):*")
            try:
            ...
            try:
                if DEPENDENCIES_AVAILABLE:
                    ...
                    try:
                        ...
                        # NOTE: Auto-trading has been moved out of generators.
                        # This generator only produces and saves predictions.
                        # Execution happens in the central trader module (modules/portfolio_trader.py).
                        ...
                        try:
                            gold_quotes = get_live_equity_fx_quotes(['XAUUSD=X']) or {}
                            gold_price_oz = gold_quotes.get('XAUUSD=X', {}).get('price', 0)
                            if gold_price_oz:
                                # IMPORTANT: system-wide, GOLD is tracked as USD/gram (see engine.market_data + dashboard).
                                entry_gold = float(gold_price_oz) / float(GOLD_GRAMS_PER_TROY_OUNCE)
        ...
        try:
            ...
            msg3_parts.append(f"{EMOJI['bullet']} *12:00 Noon Update*: Progress check + prediction verification")
