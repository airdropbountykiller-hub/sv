...
class ManualContentSender:
    ...
    def __init__(self, force_send: bool = False):
        ...
        self.available_contents = {
            'night': {
                'name': 'Night Report',
                'function': 'generate_night',
                'scheduled_time': '00:00',
                'description': '1 message - after-hours / Asia handoff'
            },
            'late_night': {
                'name': 'Late Night Update',
                'function': 'generate_late_night',
                'scheduled_time': '03:00',
                'description': '1 message - Asia session checkpoint'
            },
            'press_review': {
                'name': 'Press Review',
            ...
            'afternoon': {
                ...
                'function': 'generate_afternoon',
                'scheduled_time': '15:00',
                'description': '3 messages with mid-session tracking + ML checkpoint'
            },
            'evening': {
            ...
            'summary': {
                ...
                'description': '6-page comprehensive daily analysis'
            }
        }
    ...
    def generate_and_send(self, content_type: str, preview_only: bool = False) -> bool:
        ...
        try:
            ...
            generation_functions = {
                ...
                'generate_night': generate_night,
                'generate_late_night': generate_late_night,
                'generate_morning': generate_morning,
                'generate_noon': generate_noon,
                'generate_afternoon': generate_afternoon,
