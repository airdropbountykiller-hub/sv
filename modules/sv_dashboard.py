...
def get_intraday_timeline():
    ...
    try:
        ...
        if os.path.exists(engine_file):
            ...
            stage_order = ['press_review', 'morning', 'noon', 'evening', 'summary']
            stage_names = {
        ...
        expected_stages = [
            ('08:30', 'press_review', 'Press Review'),
            ('09:00', 'morning', 'Morning Report'),
            ('13:00', 'noon', 'Noon Update'), 
            ('18:30', 'evening', 'Evening Analysis'),
            ('20:00', 'summary', 'Daily Summary')
        ]
