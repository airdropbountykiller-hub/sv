...
Usage:
  python temp_tests/scripts/send_telegram_reports.py <report1.json> [<report2.json> ...]
"""
import os
import sys
import json
...
if len(sys.argv) < 2:
    print("Usage: python temp_tests/scripts/send_telegram_reports.py <report1.json> [<report2.json> ...]")
    sys.exit(2)
